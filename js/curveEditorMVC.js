...
// In the CEModel is the data model for the curveEditor. I should move the scaleMultiplier and origin there. 
...
function CurveEditor(parentElement,options){
	...
	this.helpfulHandles.push(new CEModel(this,'line','sharp',2,false));
	this.helpfulHandles.push(new CEModel(this,'line','sharp',2,false,{offset:1}));
	this.helpfulHandles.push(new CEModel(this,'circle','smooth',4,true));
	this.helpfulHandles.push(new CEModel(this,'circle','smooth',4,false));
	this.helpfulHandles.push(new CEModel(this,'circle','sharp',6,false));
	this.helpfulHandles.push(new CEModel(this,'circle','sharp',4,false));
	this.helpfulHandles.push(new CEModel(this,'star','smooth',4,false));
	this.helpfulHandles.push(new CEModel(this,'star','smooth',5,true));
	this.helpfulHandles.push(new CEModel(this,'star','sharp',5,false));
	this.helpfulHandles.push(new CEModel(this,'star','sharp',5,true));
	this.helpfulHandles.push(new CEModel(this,'line','sharp',5,true));
	this.helpfulHandles.push(new CEModel(this));
	...
	this.table.append("select")
		.on("change", function() { 
		  ...
		  editor.addHistory('handleChoice',null,this.value);	
		  editor.redraw(); 
		  })
...
function CEModel(editor,shape,smoothness,reflections,joined){
...
// One Handle in CEModel
// CEModel are used to set the parameters of the CubicSplines used for curves. Each handle has a point and a control point. The curve will go through
